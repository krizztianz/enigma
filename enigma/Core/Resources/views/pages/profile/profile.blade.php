@extends('core::layouts.general.homepage')
    ...
    <div class="container">
        <div class="section-2-content">
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="image">
                        <img src="{{ asset('enigma/images/image.png') }}" alt="">
                    </div>
                </div>
                ...
                <div class="feature-slider">
                    <div class="mc-item mc-item-1">
                        <div class="image-heading">
                            <img src="{{ asset('enigma/images/feature/img-1.jpg') }}" alt="">
                        </div>
                        <div class="meta-categories"><a href="#">Web design</a></div>
                        <div class="content-item">
                            <div class="image-author">
                                <img src="{{ asset('enigma/images/avatar-1.jpg') }}" alt="">
                            </div>
